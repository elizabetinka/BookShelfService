...
struct ConsoleView : View {
    ...
    mutating func run() {
        ...
        while true {
            ...
            print("4 – Поиск книги по критериям")
            print("> ", terminator: "")
            ...
            case 2: controller.getBook()
            case 3: controller.deleteBook()
            case 4: controller.filterBook()
            default:
                continue
            }
        }
...
//    
//    
//    func stringToGenre(str:String) -> Result<Genre,Error> {
...
//    }
//    
//    func stringToBookType(str:String) -> Result<TypeBook,Error> {
//        switch str {
